 ...
 * @ORM\Entity(repositoryClass="EtablissementBundle\Repository\ReclamationRepository")
 */
class Reclamation
{
    /**
    ...
    /**
     * @ORM\ManyToOne(targetEntity="EtablissementBundle\Entity\Etablissement", inversedBy="reclamations")
